<template>
  <div class="c-gallery">
    <div>
        <img src="../assets/cactus.jpg" alt="">
    </div>
    <div>
        <img src="../assets/lady-flower.jpg" alt="Collage of a woman's face covered with flowers">
    </div>
    <div>
    ...
    <div>
        <img src="../assets/beach-black-yellow.jpg" alt="">
    </div>
    <div>
    ...
    <div>
        <img src="../assets/collage-card.jpg" alt="">
    </div>
    <div>
    ...
    <div>
        <img src="../assets/collage-lady-sleeping.jpg" alt="">
    </div>
    <div>
        <img src="../assets/journal-drawing-03.jpg" alt="">
    </div>
    <div>
        <img src="../assets/journal-orange.jpg" alt="">
    </div>
  </div>
</template>
